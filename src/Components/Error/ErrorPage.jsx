            ...
            <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
                <div className="flex flex-col items-center max-w-sm mx-auto text-center">
                    ...
                    <div className="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                        ...
                        <Link to="/">
                            <button className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-green-500/50 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-green-600/60">
                                Take me home
                            </button></Link>
                    </div>
                </div>
