        ...
        <div className="flex overflow-hidden rounded-lg shadow-lg my-5 ">
            ...
            <div className="w-2/3 p-4 md:p-4 bg-green-500/20">
                ...
                <div className="flex justify-evenly items-center gap-3">
                    ...
                    <button onClick={() => setIsOpen(true)} className="btn w-44 bg-gradient-to-t from-violet-400 to-violet-600">Booked</button>
                </div>
                <BookingModal closeModal={closeModal} isOpen={isOpen} bookingInfo={test} />
            </div>
        </div>
    );
};
